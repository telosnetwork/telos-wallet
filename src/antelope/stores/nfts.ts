...
export const useNftsStore = defineStore(store_name, {
    ...
    getters: {
        getAccountNfts: state => (label: Label, address: string) => state.__nfts[label].accounts[address],
    },
    actions: {
        ...
        async fetchNFtsForAccount(label: Label, address: string) {
            ...
            const nfts: ShapedNFT[] = Object.keys(this.__nfts[label].contracts).map(
                (contractAddress: string) => this.__nfts[label].contracts[contractAddress],
            ).flat();
            ...
            contracts: {
                ...
                '0x6666666666666666666666666666666666666666': [{
                    ...
                    attributes: [{
                        ...
                        label: 'Time It Took to Make',
                        text: 'Who knows, I usually track time by how many songs I listened to while making it, but I was listening to the same song over and over. Sorry',
                    }],

...
export class EosTransitModule extends VuexModule.With({
    ...
    tx(actions) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield window.$api.signTransaction(
...
__decorate([action], EosTransitModule.prototype, "checkDevice", null);
__decorate([mutation], EosTransitModule.prototype, "setIsMobile", null);
__decorate([action], EosTransitModule.prototype, "tx", null);
__decorate([action], EosTransitModule.prototype, "initLogin", null);
__decorate([action], EosTransitModule.prototype, "logout", null);
__decorate([mutation], EosTransitModule.prototype, "setProvider", null);
__decorate([mutation], EosTransitModule.prototype, "setWallet", null);
__decorate([mutation], EosTransitModule.prototype, "setWalletState", null);
__decorate([mutation], EosTransitModule.prototype, "setAccessContext", null);

export default {
    ...
    temporal: {
        ...
        warn_old_telos_cloud_users_part_1: 'If you are an old Telos Cloud Wallet user, you need to log in first with the Google button above in order to create your brand-new account. Then log out and come back here to start the migration.',
        warn_old_telos_cloud_users_part_2: 'now you can start migrating all your assets to your new account. Please click the button below to start the migration.',

        you_need_to_migrate_title: 'Migrate your assets',
        ...
        you_need_to_migrate_nfts_first: 'You should transfer all your collectibles to your new account first, and then continue with your tokens.',
        you_need_to_migrate_all_tokens: 'You must transfer all your tokens to your new account.',
        you_need_to_migrate_nfts_title: 'Migrate your collectibles',

        assisted_migration_title: 'Assisted Migration',
        assisted_migration_msg_1: 'We have detected that you had logged in previously with your Google account and you obtained the following account:',
        assisted_migration_msg_2: 'This account is going to be suggested for you to facilitate the migration process. However, you are free to choose any other account you want.',
    },
};
